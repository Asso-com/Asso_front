...
const LessonTopicDetails: React.FC<LessonTopicDetailsProps> = ({
  sessionId,
}) => {
  ...
  return (
    <Box height="100%" maxHeight="100%" overflow="hidden" display="flex" flexDirection="column">
      <Box flexShrink={0} p={4} bg="white" borderBottom="1px solid #E2E8F0">
        <Card
          borderRadius="xl"
          border="1px solid"
