...
const DropDownLanguage = () => {
  ...
  const currentFlag = languages.find(l => l.lang === selectedLanguage)?.flag || 'US';
    ...
    <Menu isLazy>
      ...
      >
        <Flex align="center" gap={2}>
          <Flag code={currentFlag} style={{ width: '25px', borderRadius: '2px' }} />
          ...
          >
            <Flex align="center" justify="space-between" width="full">
              <Flex align="center" gap={3}>
                <Box width="20px">
                  <Flag code={flag} style={{ width: '100%', borderRadius: '2px' }} />
                </Box>
                <Text
                  fontSize="sm"
                  color={selectedLanguage === lang ? activeItemColor : 'inherit'}
